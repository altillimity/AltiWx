...
costas_mix(Costas *self, liquid_float_complex samp)
{
	liquid_float_complex nco_out;
	liquid_float_complex retval;
...
float
costas_delta(liquid_float_complex sample, liquid_float_complex cosample)
{
	float error;
