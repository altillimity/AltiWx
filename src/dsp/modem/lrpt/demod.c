...
void
demod_write_symbol(Demod *self, FILE *out_fd, liquid_float_complex sym, int nobuffer)
{
	static int offset = 0;
...
demod_thr_qpsk(void* x)
{
	...
	liquid_float_complex before, mid, cur;
...
{
	int i, count;
	liquid_float_complex tmp, inphase, quad;
	liquid_float_complex before, mid, cur;
	float prev_i;
